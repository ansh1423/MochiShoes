  ...
  return (
    <div className='mt-[50px]  h-[100vh] flex justify-center items-center border'>
        <div className='w-[500px] h-[350px] border border-black flex flex-col justify-center items-center shadow-3xl'>
                ...
                <button className='mt-[8px] ml-[10px] bg-white text-blue-800 w-[150px]  h-[40px] rounded-[0px] border border-black tracking-wide leading-3 mb-[20px] hover:bg-[#374A94] hover:text-[#fff] hover:border ' 
                   onClick={()=> router.push("/")}    >Try again</button>
        </div>
    </div>
  )
}
